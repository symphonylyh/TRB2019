...
if PLOT
    ...
    if PRINT
        print('./Plot/color space.png', '-r300', '-dpng');
    end
    ...
    if BOUNDARY_ENHANCE
        ...
        if PRINT
            print('./Plot/boundary mask.png', '-r300', '-dpng');
        end
    end
    ...
    if PRINT
        print('./Plot/distance map.png', '-r300', '-dpng');
    end
    ...
    if PRINT
        print('./Plot/threshold image.png', '-r300', '-dpng');
    end
...
if PLOT
    ...
    if PRINT
        print('./Plot/final result.png', '-r300', '-dpng');
    end
end
